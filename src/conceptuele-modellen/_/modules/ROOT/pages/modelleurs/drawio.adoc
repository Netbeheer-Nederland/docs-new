...
Voor het tekenen van conceptuele modellen gebruiken we
...
hanteren voor conceptuele modellen: entiteit-relatienotatie in
Barker-stijl.
...
Deze combinatie biedt voldoende expressiviteit voor conceptuele modellen, zonder te vervallen in technische details.
...
klasse`' (zonder instanties) niet kan bestaan in een conceptuele modellen.
...
* `+⏲+` voor tijdslijnmarkeringen (zie link:modelleurs/tijdlijnen[Tijdlijnen in
