...
Voor het tekenen van domeinmodellen gebruiken we
...
hanteren voor domeinmodellen: entiteit-relatienotatie in
Barker-stijl.
...
Deze combinatie biedt voldoende expressiviteit voor domeinmodellen, zonder te vervallen in technische details.
...
klasse`' (zonder instanties) niet kan bestaan in een domeinmodellen.
