= Capaciteitskaart
:page-link-alt-jsonld: https://modellen.netbeheernederland.nl/capaciteitskaart/2.0.0/index.jsonld
...
| Status
| http://purl.org/adms/status/UnderDevelopment[In ontwikkeling]
...
[#schema,admstype=Asset]
== Schema

.Distributions
[no-bullet,admstype=AssetDistribution]
* [[schema-linkml-yaml]] {site-url}/capaciteitskaart/2.0.0/schema/linkml.yml[Schema] (https://modellen.netbeheernederland.nl/adms-ap-nbnl/representationTechnique#linkml[LinkML]; http://publications.europa.eu/resource/authority/file-type/YAML[YAML])

include::schema:partial$index.adoc[leveloffset-=1]
